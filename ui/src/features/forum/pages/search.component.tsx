...
import type { IForumPost, IReply } from "../types/forum-types.type"; // Import types
import { Link } from "react-router-dom";
import MessageContent from "../components/message-content/message-content.component"; // Import MessageContent
import RelativeTime from "../components/relative-time/relative-time.component";
import { search } from "../api/forum-api.service";
