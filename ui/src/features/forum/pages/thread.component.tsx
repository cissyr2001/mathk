...
import type { EditorMode, IForumThread, IReply } from "../types/forum-types.type";
import TextEditor from "../components/text-editor/text-editor.component";
import RelativeTime from "../components/relative-time/relative-time.component";
...
const ThreadPage: React.FC = () => {
  ...
  const {
    ...
    queryKey: ["thread-replies", threadId, currentReplyPage, repliesPerPage],
    queryFn: () =>
  ...
  return (
    <div>
      ...
      <div className="bg-[color:var(--color-surface)] rounded-[var(--border-radius-md)] shadow-sm p-[var(--spacing-md)] mb-[var(--spacing-md)] border border-[color:var(--color-border)]">
        ...
        <MessageContent content={thread.content} mode={mainPostMode} showSourceButton={true} />
